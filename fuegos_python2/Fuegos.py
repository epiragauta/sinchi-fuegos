...
def process_data(data):
    ...
    try:
        ...
        if arcpy.Exists(shp_modis_1):
            arcpy.Select_analysis(shp_modis, "shp_modis_1")
            # Ajuste campo satellite
            arcpy.AlterField_management(shp_modis_1, "SATELLITE", "SATELLITEOLD", "", "TEXT", "1", "NULLABLE", "false")
            arcpy.AddField_management(shp_modis_1, "SATELLITE", "TEXT", "", "", "256", "", "NULLABLE", "NON_REQUIRED",
                                      "")
            arcpy.CalculateField_management(shp_modis_1, "SATELLITE", "!SATELLITEOLD!", "PYTHON_9.3", "")
            ...
            expression = "'MODIS'"
            arcpy.CalculateField_management(shp_modis_1, "INSTRUMENT", expression, "PYTHON_9.3")
            ...
            def getClass(confidence_modis):
                ...
                if confidence < 30:
                    ...
                    return 'high'"""
            arcpy.CalculateField_management(shp_modis_1, "CONFIDENCE", expression, "PYTHON_9.3",
                                            codeblock)
        ...
        if arcpy.Exists(shp_vnp):
            ...
            # Ajuste campo satellite
            arcpy.AlterField_management(shp_vnp_1, "SATELLITE", "SATELLITEOLD", "", "TEXT", "1", "NULLABLE", "false")
            arcpy.AddField_management(shp_vnp_1, "SATELLITE", "TEXT", "", "", "256", "", "NULLABLE", "NON_REQUIRED", "")
            arcpy.CalculateField_management(shp_vnp_1, "SATELLITE", "!SATELLITEOLD!", "PYTHON_9.3", "")
            ...
            arcpy.CalculateField_management(shp_vnp_1, "INSTRUMENT", expression, "PYTHON_9.3")
        ...
        if arcpy.Exists(shp_nooa):
            ...
            # Ajuste campo satellite
            arcpy.AlterField_management(shp_nooa_1, "SATELLITE", "SATELLITEOLD", "", "TEXT", "1", "NULLABLE", "false")
            arcpy.AddField_management(shp_nooa_1, "SATELLITE", "TEXT", "", "", "256", "", "NULLABLE", "NON_REQUIRED",
                                      "")
            arcpy.CalculateField_management(shp_nooa_1, "SATELLITE", "!SATELLITEOLD!", "PYTHON_9.3", "")
            ...
            arcpy.CalculateField_management(shp_nooa_1, "INSTRUMENT", expression, "PYTHON_9.3")
        ...
        if arcpy.Exists(shp_nooa_21):
            ...
            # Ajuste campo satellite
            arcpy.AlterField_management(shp_nooa_21_1, "SATELLITE", "SATELLITEOLD", "", "TEXT", "1", "NULLABLE", "false")
            arcpy.AddField_management(shp_nooa_21_1, "SATELLITE", "TEXT", "", "", "256", "", "NULLABLE", "NON_REQUIRED","")
            arcpy.CalculateField_management(shp_nooa_21_1, "SATELLITE", "!SATELLITEOLD!", "PYTHON_9.3", "")
            ...
            arcpy.CalculateField_management(shp_nooa_21_1, "INSTRUMENT", expression, "PYTHON_9.3")
        ...
        arcpy.CalculateField_management(amazonia_without_pozos_lyr, "FECHA_DESC", expression, "PYTHON_9.3", codeblock)

        expression = "getFecha()"
        codeblock = """def getFecha():
                            return time.strftime("%d/%m/%Y %H:%M:%S")"""
        arcpy.CalculateField_management(amazonia_without_pozos_lyr, "FECHA_DATE", expression, "PYTHON_9.3", codeblock)
...
def deleteRows(feature_class, fecha_campo, fecha_obj):
    logging.debug("deleting rows... field: {}, date: {}".format(fecha_campo, fecha_obj.strftime("%Y-%m-%d")))
...
def main(data):
    ...
    try:
        if not data["is_test"]:
            ...
            deleteRows(data['layer_output_prod'], "acq_date", fecha_anterior)
            deleteRows(data['layer_output_pub'], "acq_date", fecha_anterior)
            deleteRows(data['layer_output_pub_sirgas'], "acq_date", fecha_anterior)
    except Exception as e:
        print_error(e)
        to = list(data["admin_emails"])
        subject = "SIATAC - Procesamiento de Fuegos - Error - {} ".format(current_day)
